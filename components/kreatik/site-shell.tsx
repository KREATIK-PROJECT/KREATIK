    ...
    <header className="relative z-50 border-b border-white/10 bg-[#12141C]/95 px-5 py-5 backdrop-blur-md md:px-10">
      <div className="mx-auto flex max-w-[1440px] items-center justify-between">
        <div className="flex items-center gap-4">
          <Link href="/" className="flex items-center" aria-label="Kreatik accueil">
            <Image src="/kreatik/logo-kreatik-wordmark.png" alt="KREATIK" width={900} height={187} className="h-7 w-auto md:h-8" priority />
          </Link>
